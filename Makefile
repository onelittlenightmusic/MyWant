...
run-sample-owner:
	go run cmd/demos/demo_qnet_owner.go

run-sample-owner-config:
	go run cmd/demos/demo_qnet_owner.go config/config-sample-owner.yaml

run-sample-owner-high-throughput:
	go run cmd/demos/demo_qnet_owner.go config/config-sample-owner-high-throughput.yaml

run-sample-owner-dry:
	go run cmd/demos/demo_qnet_owner.go config/config-sample-owner-dry.yaml

run-sample-owner-input:
	go run cmd/demos/demo_qnet_owner.go config/config-sample-owner-input.yaml

run-qnet-target:
	go run cmd/demos/demo_qnet_owner.go config/config-qnet.yaml
...
run-queue-system-recipe:
	go run cmd/demos/demo_queue_system_recipe.go config/config-queue-system-recipe.yaml

run-qnet-recipe:
	go run cmd/demos/demo_qnet_recipe.go config/config-qnet-recipe.yaml

run-qnet-using-recipe:
	go run cmd/demos/demo_qnet_using_recipe.go config/config-qnet-using-recipe.yaml
