...
function buildCorrelationStyle(_rate: number): React.CSSProperties {
  return {};
}
...
const CardProgressBars: React.FC<{ achievingPercentage: number }> = ({ achievingPercentage }) => (
  <>
    <div style={{
...
const CardCorrelationOverlay: React.FC<{ rate?: number }> = ({ rate }) => {
...
const ChildWantCard: React.FC<ChildWantCardProps> = ({
  child,
  selectedWant,
  correlationRate,
  isSelectMode,
  ...
  const handleDragOver = (e: React.DragEvent) => {
    ...
    if (isWantDrag) {
      e.preventDefault();
      e.stopPropagation(); // Stop propagation to parent WantCard
      if (isTarget) {
  ...
  return (
    <div
      ...
      style={{ ...childBackgroundStyle.style, ...correlationStyle }}
      onClick={handleClick}
...
export const WantCard: React.FC<WantCardProps> = ({
  ...
  return (
    ...
    >
      <CardProgressBars achievingPercentage={achievingPercentage} />
      <CardCorrelationOverlay rate={correlationRate} />
