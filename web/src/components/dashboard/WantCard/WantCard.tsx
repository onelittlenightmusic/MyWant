    ...
    <div className="relative h-full" style={{ isolation: 'isolate' }}>
      ...
      <div
        ...
        className={classNames(
          `card hover:shadow-md dark:hover:shadow-blue-900/20 transition-all duration-300 group relative overflow-hidden h-full min-h-[6rem] sm:min-h-[10rem] flex flex-col select-none ${CARD_FOCUS_BASE}`,
          CARD_BORDER_BASE,
      ...
      >
        ...
        {hasChildren && (!isControl || selected) && (
          <div className={classNames(
            "absolute bottom-0 left-0 right-0 z-10 border-t border-gray-200/50 dark:border-gray-700/50 px-3 py-1.5 flex items-center justify-end gap-2",
