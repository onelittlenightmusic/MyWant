...
func (s *Server) setupRoutes() {
	...
	wants.HandleFunc("/{id}/restart", s.restartWant).Methods("POST")
	...
	wants.HandleFunc("/restart", s.restartWants).Methods("POST")
	...
	states.HandleFunc("/{id}", s.clearWantState).Methods("DELETE")
