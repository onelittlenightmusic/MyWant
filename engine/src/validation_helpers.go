...
func GetMapField(obj map[string]interface{}, key, fieldName string) (map[string]interface{}, error) {
	value, ok := obj[key]
	if !ok {
...
func GetArrayField(obj map[string]interface{}, key, fieldName string) ([]interface{}, error) {
	value, ok := obj[key]
	if !ok {
		return nil, fmt.Errorf("missing required '%s' field", fieldName)
	}
...
func GetStringField(obj map[string]interface{}, key, fieldName string) (string, error) {
	value, ok := obj[key]
	if !ok {
...
func GetStringFieldOptional(obj map[string]interface{}, key string) string {
	value, ok := obj[key]
	if !ok {
		return ""
	}
...
func GetIntField(obj map[string]interface{}, key, fieldName string) (int, error) {
	value, ok := obj[key]
	if !ok {
...
func GetIntFieldWithDefault(obj map[string]interface{}, key string, defaultValue int) int {
	value, ok := obj[key]
	if !ok {
		return defaultValue
	}
...
func ValidateArrayElementAsMap(element interface{}, index int, elementType string) (map[string]interface{}, error) {
...
func ValidateRequiredMapFields(obj map[string]interface{}, index int, elementType string, requiredFields []string) error {
...
func ExtractMapString(obj map[string]interface{}, key string) string {
...
func ExtractMapInt(obj map[string]interface{}, key string) int {
	if value, ok := obj[key]; ok {
		if intVal, ok := AsInt(value); ok {
			return intVal
		}
...
func ExtractMapBool(obj map[string]interface{}, key string) bool {
	if value, ok := obj[key]; ok {
...
func ExtractMapMap(obj map[string]interface{}, key string) map[string]interface{} {
	if value, ok := obj[key]; ok {
...
func ExtractMapArray(obj map[string]interface{}, key string) []interface{} {
	if value, ok := obj[key]; ok {
