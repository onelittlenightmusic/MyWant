...
[Want System](docs/want-system.md) • [Agent System](docs/agent-system.md) • [Execution Modes](docs/AgentExecutionModes.md) • [Developer Guide](docs/WantDeveloperGuide.md) • [Want Card Plugin System](docs/WantCardPluginSystem.md) • [Robot Request Pipeline](docs/robot-request-pipeline.md) • [Agent Catalog](AGENTS.md) • [CLI Usage](docs/MYWANT_CLI_USAGE.md) • [Auth / Remote Backends](docs/auth.md) • [Examples](docs/agent-examples.md) • [Webhook (Teams/Slack)](docs/TEAMS_WEBHOOK_SPEC.md) • [Shortcuts](web/SHORTCUTS_AND_MCP_TESTING.md)
